...
struct PositionMeasurementArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::people_msgs::PositionMeasurement_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::people_msgs::PositionMeasurement_<ContainerAllocator> >> _people_type;
  _people_type people;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _cooccurrence_type;
...
bool operator==(const ::people_msgs::PositionMeasurementArray_<ContainerAllocator1> & lhs, const ::people_msgs::PositionMeasurementArray_<ContainerAllocator2> & rhs)
{
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::people_msgs::PositionMeasurementArray_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.people.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::people_msgs::PositionMeasurement_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.people[i]);
    }
    if (v.people.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "cooccurrence: ";
    if (v.cooccurrence.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.cooccurrence.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.cooccurrence[i]);
    }
    if (v.cooccurrence.empty() || true)
      s << "]";
  }
