...
bool operator==(const ::people_msgs::PositionMeasurement_<ContainerAllocator1> & lhs, const ::people_msgs::PositionMeasurement_<ContainerAllocator2> & rhs)
{
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::people_msgs::PositionMeasurement_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.covariance.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.covariance[i]);
    }
    if (v.covariance.empty() || true)
      s << "]";
    if (true || !indent.empty())
