...
struct People_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::people_msgs::Person_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::people_msgs::Person_<ContainerAllocator> >> _people_type;
  _people_type people;
...
bool operator==(const ::people_msgs::People_<ContainerAllocator1> & lhs, const ::people_msgs::People_<ContainerAllocator2> & rhs)
{
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::people_msgs::People_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.people.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::people_msgs::Person_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.people[i]);
    }
    if (v.people.empty() || false)
      s << "]";
  }
