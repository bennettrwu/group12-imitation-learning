...
bool operator==(const ::jsk_recognition_msgs::TowerPickUpRequest_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::TowerPickUpRequest_<ContainerAllocator2> & rhs)
{
  return lhs.tower_index == rhs.tower_index;
}
