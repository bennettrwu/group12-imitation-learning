...
struct ContactSensorArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::jsk_recognition_msgs::ContactSensor_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::jsk_recognition_msgs::ContactSensor_<ContainerAllocator> >> _datas_type;
  _datas_type datas;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jsk_recognition_msgs::ContactSensorArray_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.datas.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::jsk_recognition_msgs::ContactSensor_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.datas[i]);
    }
    if (v.datas.empty() || false)
      s << "]";
  }
