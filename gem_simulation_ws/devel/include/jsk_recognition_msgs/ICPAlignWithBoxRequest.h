...
bool operator==(const ::jsk_recognition_msgs::ICPAlignWithBoxRequest_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::ICPAlignWithBoxRequest_<ContainerAllocator2> & rhs)
{
  return lhs.target_cloud == rhs.target_cloud &&
    lhs.target_box == rhs.target_box;
}
