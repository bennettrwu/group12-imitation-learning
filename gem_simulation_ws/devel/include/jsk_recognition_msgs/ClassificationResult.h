...
struct ClassificationResult_
{
  ...
  _labels_type labels;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _label_names_type;
  _label_names_type label_names;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _label_proba_type;
  ...
  _probabilities_type probabilities;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _classifier_type;
  _classifier_type classifier;

   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _target_names_type;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jsk_recognition_msgs::ClassificationResult_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.labels.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint32_t>::stream(s, true ? std::string() : indent + "    ", v.labels[i]);
    }
    if (v.labels.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "label_names: ";
    if (v.label_names.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.label_names.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.label_names[i]);
    }
    if (v.label_names.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "label_proba: ";
    if (v.label_proba.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.label_proba.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.label_proba[i]);
    }
    if (v.label_proba.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "probabilities: ";
    if (v.probabilities.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.probabilities.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.probabilities[i]);
    }
    if (v.probabilities.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "classifier: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.classifier);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "target_names: ";
    if (v.target_names.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.target_names.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.target_names[i]);
    }
    if (v.target_names.empty() || true)
      s << "]";
  }
