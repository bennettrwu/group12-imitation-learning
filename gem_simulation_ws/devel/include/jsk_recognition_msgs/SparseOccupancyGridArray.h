...
struct SparseOccupancyGridArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::jsk_recognition_msgs::SparseOccupancyGrid_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::jsk_recognition_msgs::SparseOccupancyGrid_<ContainerAllocator> >> _grids_type;
  _grids_type grids;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jsk_recognition_msgs::SparseOccupancyGridArray_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.grids.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::jsk_recognition_msgs::SparseOccupancyGrid_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.grids[i]);
    }
    if (v.grids.empty() || false)
      s << "]";
  }
