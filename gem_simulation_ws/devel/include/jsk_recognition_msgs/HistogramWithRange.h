...
struct HistogramWithRange_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::jsk_recognition_msgs::HistogramWithRangeBin_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::jsk_recognition_msgs::HistogramWithRangeBin_<ContainerAllocator> >> _bins_type;
  _bins_type bins;
...
bool operator==(const ::jsk_recognition_msgs::HistogramWithRange_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::HistogramWithRange_<ContainerAllocator2> & rhs)
{
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jsk_recognition_msgs::HistogramWithRange_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.bins.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::jsk_recognition_msgs::HistogramWithRangeBin_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.bins[i]);
    }
    if (v.bins.empty() || false)
      s << "]";
  }
