...
#if defined(_WIN32) && defined(MODEL_PLANE)
  #undef MODEL_PLANE
#endif
#if defined(_WIN32) && defined(MODEL_CYLINDER)
  #undef MODEL_CYLINDER
#endif
...
bool operator==(const ::jsk_recognition_msgs::SnapItRequest_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::SnapItRequest_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.model_type == rhs.model_type &&
    lhs.target_plane == rhs.target_plane &&
    lhs.center == rhs.center &&
    lhs.direction == rhs.direction &&
    lhs.radius == rhs.radius &&
    lhs.height == rhs.height &&
    lhs.max_distance == rhs.max_distance &&
    lhs.eps_angle == rhs.eps_angle;
}
