...
struct PointsArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::sensor_msgs::PointCloud2_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sensor_msgs::PointCloud2_<ContainerAllocator> >> _cloud_list_type;
...
bool operator==(const ::jsk_recognition_msgs::PointsArray_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::PointsArray_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.cloud_list == rhs.cloud_list;
}
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jsk_recognition_msgs::PointsArray_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.cloud_list.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::sensor_msgs::PointCloud2_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.cloud_list[i]);
    }
    if (v.cloud_list.empty() || false)
      s << "]";
  }
