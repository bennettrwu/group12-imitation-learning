...
bool operator==(const ::jsk_recognition_msgs::SaveMeshResponse_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::SaveMeshResponse_<ContainerAllocator2> & rhs)
{
