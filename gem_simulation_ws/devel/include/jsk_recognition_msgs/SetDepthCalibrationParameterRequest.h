...
bool operator==(const ::jsk_recognition_msgs::SetDepthCalibrationParameterRequest_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::SetDepthCalibrationParameterRequest_<ContainerAllocator2> & rhs)
{
