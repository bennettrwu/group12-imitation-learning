...
struct ColorHistogramArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::jsk_recognition_msgs::ColorHistogram_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::jsk_recognition_msgs::ColorHistogram_<ContainerAllocator> >> _histograms_type;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jsk_recognition_msgs::ColorHistogramArray_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.histograms.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::jsk_recognition_msgs::ColorHistogram_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.histograms[i]);
    }
    if (v.histograms.empty() || false)
      s << "]";
  }
