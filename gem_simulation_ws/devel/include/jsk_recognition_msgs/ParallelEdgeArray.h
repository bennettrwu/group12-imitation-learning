...
struct ParallelEdgeArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::jsk_recognition_msgs::ParallelEdge_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::jsk_recognition_msgs::ParallelEdge_<ContainerAllocator> >> _edge_groups_type;
...
struct Printer< ::jsk_recognition_msgs::ParallelEdgeArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jsk_recognition_msgs::ParallelEdgeArray_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "edge_groups: ";
    if (v.edge_groups.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.edge_groups.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::jsk_recognition_msgs::ParallelEdge_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.edge_groups[i]);
    }
    if (v.edge_groups.empty() || false)
      s << "]";
  }
