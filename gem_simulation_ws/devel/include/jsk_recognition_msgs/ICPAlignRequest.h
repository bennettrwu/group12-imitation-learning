...
bool operator==(const ::jsk_recognition_msgs::ICPAlignRequest_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::ICPAlignRequest_<ContainerAllocator2> & rhs)
{
  return lhs.reference_cloud == rhs.reference_cloud &&
    lhs.target_cloud == rhs.target_cloud;
}
