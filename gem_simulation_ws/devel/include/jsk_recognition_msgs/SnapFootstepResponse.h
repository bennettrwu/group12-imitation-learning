...
bool operator==(const ::jsk_recognition_msgs::SnapFootstepResponse_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::SnapFootstepResponse_<ContainerAllocator2> & rhs)
{
