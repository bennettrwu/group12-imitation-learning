...
bool operator==(const ::jsk_recognition_msgs::WhiteBalanceResponse_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::WhiteBalanceResponse_<ContainerAllocator2> & rhs)
{
