...
bool operator==(const ::jsk_recognition_msgs::CallSnapItRequest_<ContainerAllocator1> & lhs, const ::jsk_recognition_msgs::CallSnapItRequest_<ContainerAllocator2> & rhs)
{
