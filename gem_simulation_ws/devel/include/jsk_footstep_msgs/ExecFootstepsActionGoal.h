...
bool operator==(const ::jsk_footstep_msgs::ExecFootstepsActionGoal_<ContainerAllocator1> & lhs, const ::jsk_footstep_msgs::ExecFootstepsActionGoal_<ContainerAllocator2> & rhs)
{
