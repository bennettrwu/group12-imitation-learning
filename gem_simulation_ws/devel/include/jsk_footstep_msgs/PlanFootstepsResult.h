...
bool operator==(const ::jsk_footstep_msgs::PlanFootstepsResult_<ContainerAllocator1> & lhs, const ::jsk_footstep_msgs::PlanFootstepsResult_<ContainerAllocator2> & rhs)
{
