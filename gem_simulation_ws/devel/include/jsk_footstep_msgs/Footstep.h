...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef APPROVED
#endif
#if defined(_WIN32) && defined(LLEG)
  #undef LLEG
#endif
#if defined(_WIN32) && defined(RLEG)
  #undef RLEG
#endif
#if defined(_WIN32) && defined(LARM)
  #undef LARM
#endif
#if defined(_WIN32) && defined(RARM)
  #undef RARM
#endif
...
bool operator==(const ::jsk_footstep_msgs::Footstep_<ContainerAllocator1> & lhs, const ::jsk_footstep_msgs::Footstep_<ContainerAllocator2> & rhs)
{
  return lhs.leg == rhs.leg &&
    lhs.pose == rhs.pose &&
    lhs.duration == rhs.duration &&
    lhs.footstep_group == rhs.footstep_group &&
