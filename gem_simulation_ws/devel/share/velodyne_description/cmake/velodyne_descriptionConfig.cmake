...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_description_SOURCE_PREFIX /home/bennett/host/Documents/group12-imitation-learning/gem_simulation_ws/src/POLARIS_GEM_Simulator/ros_drivers/velodyne_simulator/velodyne_description)
  set(velodyne_description_DEVEL_PREFIX /home/bennett/host/Documents/group12-imitation-learning/gem_simulation_ws/devel)
  ...
  set(velodyne_description_INSTALL_PREFIX /home/bennett/host/Documents/group12-imitation-learning/gem_simulation_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bennett/host/Documents/group12-imitation-learning/gem_simulation_ws/src/POLARIS_GEM_Simulator/ros_drivers/velodyne_simulator/velodyne_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT velodyne_description_NUM_DUMMY_TARGETS)
      set(velodyne_description_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::velodyne_description::wrapped-linker-option${velodyne_description_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR velodyne_description_NUM_DUMMY_TARGETS "${velodyne_description_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::velodyne_description::wrapped-linker-option${velodyne_description_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND velodyne_description_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND velodyne_description_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(velodyne_description_EXPORTED_TARGETS ${${velodyne_description_dep}_EXPORTED_TARGETS})
endforeach()
